...
<body>
    ...
    <form action="editRider.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="race_performance" value="<?php echo $row['race_performance']; ?>" required>
        </div>

        <div class="form-group">
            <label for="qualy_performance">Qualy Performance</label>
            <input type="text" name="qualy_performance" value="<?php echo $row['qualy_performance']; ?>" required>
        </div>

        <div class="form-group">
            <label for="wet_performance">Wet Performance</label>
            <input type="text" name="wet_performance" value="<?php echo $row['wet_performance']; ?>" required>
        </div>

        <div class="form-group">
            <label for="crash_possibility">Crash Possibility</label>
            <input type="text" name="crash_possibility" value="<?php echo $row['crash_possibility']; ?>" required>
        </div>
