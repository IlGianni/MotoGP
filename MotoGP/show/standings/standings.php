    ...
    <?php
        ...
        if(isset($_GET['category']) AND isset($_GET['season'])){
            ...
            $sql = "SELECT rider.name, rider.surname, rider.number, standings.points, rider.nation, team.color, category.name AS cName, team.name as teamName FROM standings 
                ...
                WHERE standings.idCategory = " . $category . " AND idSeason = " . $season . " ORDER BY points DESC";
            $result = mysqli_query($conn, $sql);
            if(!$result){
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                if($position == 1){
                    ...
                    echo "<div class='distance'>
                        <label class='distance'>-" . $firstPoints - $row['points'] . "</label>
                    </div>";
                }
        ...
        echo "<div class='button-container'>
                ...
                <button class='button-54' onclick='location.href=\"standings.php\"'>Back</button>
                <button class='button-54' onclick='location.href=\"standingsTeam.php\"'>Next</button>
